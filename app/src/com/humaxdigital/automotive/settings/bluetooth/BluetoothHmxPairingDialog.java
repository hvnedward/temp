...
/**
 * BluetoothHmxPairingDialog asks the user to enter a PIN / Passkey / simple confirmation
 * for pairing with a remote Bluetooth device. It is an activity that appears as a dialog.
 */
public class BluetoothHmxPairingDialog extends Activity {
    public static final String FRAGMENT_TAG = "bluetooth.pairing.fragment";

    private BluetoothHmxPairingController mBluetoothPairingController;
    private boolean mReceiverRegistered = false;

    /**
     * Dismiss the dialog if the bond state changes to bonded or none,
     * or if pairing was canceled for {@link BluetoothHmxPairingController#mDevice}.
     */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBluetoothPairingController = new BluetoothHmxPairingController(intent, this);
        ...
        BluetoothPairingDialogFragment bluetoothFragment =
            ...
            */
		BluetoothHmxPairingDialogFragment bluetoothFragment =
		(BluetoothHmxPairingDialogFragment) getFragmentManager().findFragmentByTag(FRAGMENT_TAG);
        ...
        if (bluetoothFragment == null) {
			...
			/*
	            ...
	            */
	        bluetoothFragment = new BluetoothHmxPairingDialogFragment();    
        }
