...
public abstract class BluetoothScanningDevicesGroupPreferenceController extends
    ...
    public BluetoothScanningDevicesGroupPreferenceController(Context context, String preferenceKey,
        ...
        LOG.d("BluetoothScanningDevicesGroupPreferenceController ");
        ...
        for (CachedBluetoothDevice device : getPreferenceMap().keySet()) {
            ...
            */
            ...
            if (device.isBusy() == true) {
				LOG.d("shouldEnableScanning  isBusy() : " + device.isBusy());				
                return false;
            }
			else
			{
    ...
    private void enableScanning() {
		...
		LOG.d("enableScanning  isDiscovering() : " + mBluetoothAdapter.isDiscovering());
    ...
    private void disableScanning() {
   		LOG.d("disableScanning  isDiscovering() : " + mBluetoothAdapter.isDiscovering());
    ...
    public void onConnectionStateChanged(CachedBluetoothDevice cachedDevice, int state) {
        LOG.d("onConnectionStateChanged device: " + cachedDevice + " state: " + state);
        refreshUi();
   	}
    ...
    private static final class AlwaysDiscoverable extends BroadcastReceiver {
        ...
        void stop() {
            ...
            mStarted = false;
			LOG.d("setScanMode BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE");			
