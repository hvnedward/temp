...
import com.humaxdigital.automotive.settings.bluetooth.BluetoothHmxPairingDialogFragment.BluetoothPairingDialogListener;
...
/**
 * A controller used by {@link BluetoothHmxPairingDialog} to manage connection state while we try to
 * pair with a bluetooth device. It includes methods that allow the
 * {@link BluetoothHmxPairingDialogFragment} to interrogate the current state as well.
 */
public class BluetoothHmxPairingController implements OnCheckedChangeListener,
        BluetoothPairingDialogListener {

    private static final Logger LOG = new Logger(BluetoothHmxPairingController.class);
    ...
    /**
     * Creates an instance of a BluetoothHmxPairingController.
     *
     ...
     */
    public BluetoothHmxPairingController(Intent intent, Context context) {
    ...
    @Override
    public void onDialogPositiveClick(BluetoothHmxPairingDialogFragment dialog) {
    ...
    @Override
    public void onDialogNegativeClick(BluetoothHmxPairingDialogFragment dialog) {
        onCancel();
    }
     ...
     * @see {@link BluetoothHmxPairingController#hasPairingContent()}
     */
     ...
     * {@link BluetoothHmxPairingDialogFragment} when it is dismissed.
     */
