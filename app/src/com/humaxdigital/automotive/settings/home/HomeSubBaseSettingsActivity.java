...
/**
 * SettingsActivity for SubBaseFragment
 */
public class HomeSubBaseSettingsActivity extends SubSettingsActivity {

    private static final Logger LOG = new Logger(HomeSubBaseSettingsActivity.class);
    ...
    protected int getLayoutResourceId() {
        return R.layout.hmx_sub_base_settings_activity;
    }
    ...
    protected Fragment getFragmentForIntent(Context context, @Nullable Intent intent) {
        ...
        switch (action) {
            case SettingsConstants.ACTION_DATE_SETTINGS:
                return new DatePickerFragment();

            case SettingsConstants.ACTION_TIME_SETTINGS:
                return new TimePickerFragment();

            case SettingsConstants.ACTION_SYSTEM_INFO_SETTINGS:
                return new SystemInfoUpdateFragment();

            case SettingsConstants.ACTION_RESET_SETTINGS:
