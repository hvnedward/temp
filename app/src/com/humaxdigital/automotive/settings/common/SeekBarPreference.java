...
public class SeekBarPreference extends Preference {
    ...
    private boolean mShowValuePercent;
    ...
    public SeekBarPreference(
        ...
        mShowValuePercent = a.getBoolean(R.styleable.SeekBarPreference_showValuePercent, true);
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        if (mSeekBarValueTextView != null) {
            String text;
            if (mShowValuePercent) {
                text = String.valueOf((mSeekBarValue - mMin) * 100 / (mMax - mMin) );
                text += " %";
            }
            else {
        ...
        minusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setValue(getValue() - mSeekBarIncrement);
            }
        });
