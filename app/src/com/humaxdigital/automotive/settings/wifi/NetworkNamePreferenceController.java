...
import com.humaxdigital.automotive.settings.common.EditInputTextPreference;

/** Business logic for adding/displaying the network name. */
public class NetworkNamePreferenceController extends PreferenceController<EditInputTextPreference> {
    ...
    @Override
    protected Class<EditInputTextPreference> getPreferenceType() {
        return EditInputTextPreference.class;
    }

    @Override
    protected void updateState(EditInputTextPreference preference) {
...
//                R.string.default_network_name_summary) : preference.getText());
    ...
    @Override
    protected boolean handlePreferenceChanged(EditInputTextPreference preference, Object newValue) {
