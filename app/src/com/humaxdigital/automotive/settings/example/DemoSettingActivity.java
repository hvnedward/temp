 ...
 */
public class DemoSettingActivity extends BaseCarSettingsActivity {

    private static final Logger LOG = new Logger(DemoSettingActivity.class);

    private final static String SETTINGS_EXAMPLE_DEMO_FRAGMENT =
            "com.humaxdigital.automotive.settings.example.DemoFragment";
    ...
    protected void onResume() {
        super.onResume();
        if (mHasNewIntent) {
            Fragment fragment = DemoFragmentResolver.getFragmentForIntent(/* context= */ this,
                    getIntent());
    ...
    public void launchFragment(Fragment fragment) {
        ...
        if (fragment.getClass().getName().equals(
                SETTINGS_EXAMPLE_DEMO_FRAGMENT)
