 ...
 */
public class TimeZonePickerPreferenceController extends PreferenceController<PaneSubPreference> {
    ...
    protected void updateState(PaneSubPreference preference) {
        ...
        preference.setValue(ZoneGetter.getTimeZoneOffsetAndName(getContext(), now.getTimeZone(),
                now.getTime()));
