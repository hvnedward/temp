 ...
 */
public class TimeFormatTogglePreferenceController extends PreferenceController<ToggleSwitchPreference> {
    private static final String TAG = TimeFormatTogglePreferenceController.class.getSimpleName();
